  angular.module('app').directive('dirDisqus', ['$window', function($window) {
        return {
            restrict: 'E',
            scope: {
                disqus_shortname: '@disqusShortname',
                disqus_identifier: '@disqusIdentifier',
                disqus_title: '@disqusUrl',
            ...
            link: function(scope) {
                ...
                scope.$watch("readyToBind", function(isReady) {
                    ...
                    if (scope.$eval(isReady)) {
                      console.log('url '+scope.disqus_url);
                       console.log('identifier '+scope.disqus_identifier)
